...
(defun dired-actions-copy ()
  ...
  (message "Copied %s Files" (length dired-actions--file-ring))
...
(defun dired-actions-paste ()
  "Paste the file/s from the file ring to current dir."
  (interactive)
...
(defun dired-actions-hardlink ()
  "Create a relative symlink for the file/s from the file ring to current dir.
